<?php
/*
 * Log 			A logger class which creates logs when an exception is thrown. @author		Author: Vivek Wicky Aswal. (https://twitter.com/#!/VivekWickyAswal) @git 			https://github.com/indieteq/PHP-MySQL-PDO-Database-Class @version 0.1a
 */
class Log {
     ...
     *            the message which is written into the log.
     */
